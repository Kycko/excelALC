  ...
  def __init__(self):
    ...
    self.build = {
      ...
      'il:rmRC'        : _getShared('il:taskBtn',
                                   {'inner':{'cmd'  :{'lmb' :'rmRC'},
                                             'build':{'text': S.UI['tasks']['rmRC']['ilBtn']}}}),
      'ilBottom'       :{'type' : 'fr',
      ...
      'ir'             :{'rules':{'start':('saveProps'),'final':('build:ir','bindLogs')},
                         'type' : 'lfr',
                         'wxKey': 'ir',
      ...
      'irFile:upd'     :{'type' : 'btn',
                         ...
                         'pack' :{'side'     :'right',
                                  'fill'     :'both'}},
      'ir:launchBtn'   :{'rules':{'final':('setFocus')},
                         'type' : 'btn',
                         'wxKey': 'ir:launchBtn',
      ...
      'rbfExit'        :{'rules':{'final':('setFocus')},
                         'type' : 'btn',
                         'cmd'  :{'type':'rbExit'},
                         'build':{'text':self.icons['back']+S.UI['rbfExit'],
                                  'bootstyle':'success'},
                         'pack' :{'anchor':'w','padx':2,'pady':3}},
      'rbfShowLog'     :{'rules':{'final':('rbfShowLog')},
                         'type' : 'btn',
                         'cmd'  :{'type':'rbfShowLog'},
                         'build':{'text'     : S.UI['rbfShowLog'],
                                  'bootstyle':'info-outline'},
                         'pack' :{'anchor':'w','padx':2,'pady':3}},
      'rbfShowErrors'  :{'rules':{'final':('rbfShowErrors')},
                         'type' : 'btn',
