...
layout = {
    ...
    'actionsCfg':{  # настройки конкретных проверок
        'forAll':{
            'newSheet'  :{
                'type'  :  'check',  # check/radio/entryList ("да/нет"/радиовыбор/выпадающий список со свободным вводом)
    ...
    # ↓ это текстовые поля ввода
    'getOnLaunch':{'fillBlanks':{'filler':'Что вписать в пустые?'}}
    }
layout['actionsCfg']['allChecks'].update(layout['actionsCfg']['checkTitles'])
