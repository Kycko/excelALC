...
layout = {
    ...
    'actionsCfg':{  # настройки конкретных проверок
        ...
        'checkPhones':{
            'blanks' :{'lbl':'  Вписать в пустые ячейки телефон 79999999999',
...
log = {'mainLaunch'  : '[$$1] Файл: $$2',   # 1:время запуска, 2:имя проверяемого файла
       ...
       'finalWrite'  :{'main' :'Результат записан на $$1 лист',             # 1 заменяется на след. ключ sheet
                       'sheet':('тот же','новый')},
       'colorErrors' :{'skip' :'Ошибки не будут выделены красным (общее количество > 100 шт.)',
                       'done' :'Ошибки выделены красным: $$1 шт.',          # 1:кол-во ошибок
                       '0'    :'Ошибок не осталось'}}

# ошибки ввода для suggUI
errInput = {'phone'  :{'firstSymb'  :'Первая цифра 7?',
