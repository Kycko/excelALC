...
layout = {
    ...
    'run'     : {'log'   : '  Журнал  ',
                 'errors': '  Ошибки  ',
                 'suggUI':  {'title'      : 'Ошибка', # для окна с предложением исправить ошибку
                             'msg'        : 'Введите правильный вариант$$1 или нажмите "Отмена", чтобы исправить его потом.\n\n$$2:\n• $$3\n\n',
...
# записи в журнале
log = {'readFile': {'full' : '[core] Прочитана вся таблица: %1, 1 заголовок + %2.', # %1 – столбцы, %2 – строки
                    'range': '[core] Прочитан диапазон: %1, %2.'}}                  # %1 – столбцы, %2 – строки
