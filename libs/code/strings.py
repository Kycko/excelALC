...
layout = {
    ...
    'run' :{
        'lfl'   :{'mainLog':'  Журнал  ',
                  'sugg'   :'  Исправление ошибок$$1  ',    # $$1 заменим либо на счётчик, либо на ''
        ...
        'suggUI':{ # для диалога исправления ошибок
            ...
            'lblInvalid':'Это значение не подходит',
...
# записи в журнале
log = {'mainLaunch'  :'[core] [$$1] Файл: $$2',   # 1:время запуска, 2:имя проверяемого файла
       'readSheet'   :'[core] Выбран лист: $$1',
       ...
       'suggFinished':{'cancelled':'[sugg] [$$1] Отменено пользователем: $$2',      # 1:тип, 2:что
                       'accepted' :'[sugg] [$$1] Исправлено вручную: $$2 -> $$3'}}  # 1:тип, 2:что, 3:на что
