...
class userCfg():
    ...
    def create(self):
        self.storage = get_initSettings()   # self.storage – основное хранилище всех настроек
        self.write()
    def read (self): self.toStorage(readFile(self.file))
    def write(self):   write_toFile(self.parseStorage(),self.file)
